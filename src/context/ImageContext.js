...
export const ImageProvider = ({ children }) => {
  ...
  const fetchImages = async () => {
    try {
      const response = await axios.get(`http://192.168.100.148:3230/api/image/fetch`);
  ...
  const runImage = async (imageId) => {
    try {
      await axios.get(`http://192.168.100.148:3230/api/image/command?image=${imageId}&command=run`);
  ...
  const deleteImage = async (imageId) => {
    try {
      await axios.get(`http://192.168.100.148:3230/api/image/command?image=${imageId}&command=remove`);
